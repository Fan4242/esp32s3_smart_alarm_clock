...
typedef struct
{
	...
	lv_obj_t *screen_home_label_temple1;
	lv_obj_t *screen_home_label_temple2;
	lv_obj_t *screen_home_label_temple3;
	...
	lv_obj_t *screen_monitor_label_staus;
	lv_obj_t *screen_monitor_cont_men;
	lv_obj_t *screen_monitor_label_mem_title;
	lv_obj_t *screen_monitor_label_mem_used;
	lv_obj_t *screen_monitor_label_mem_valid;
	lv_obj_t *screen_monitor_label_men_value1;
	lv_obj_t *screen_monitor_label_men_value2;
...
LV_IMAGE_DECLARE(_line_RGB565A8_280x11);
LV_IMAGE_DECLARE(_qing_RGB565A8_48x48);
LV_IMAGE_DECLARE(_yun_RGB565A8_48x48);
LV_IMAGE_DECLARE(_yu_RGB565A8_48x48);
